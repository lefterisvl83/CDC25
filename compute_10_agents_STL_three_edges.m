function [uopt, xopt, elapsedTime] = compute_10_agents_STL_three_edges(uk_1,k,x0,xk,C,c,rob,xk1,xk2,xk3,e1,e2,e3,M,A,B,ulim,t,g,j,N,gamma,gurobi_iter,E,X)% E is the PRS, X is the tight workspace
%
y1=[];
y2=[];
y3=[];
